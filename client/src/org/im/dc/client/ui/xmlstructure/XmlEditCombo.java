...
public class XmlEditCombo extends XmlEditBase<JFilterComboBox> implements IXmlSimpleElement {
    public XmlEditCombo(ArticleUIContext context, XmlGroup parentPanel, AnnotationInfo ann, boolean parentWritable) {
